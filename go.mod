...
require (
	...
	github.com/buildkite/agent/v3 v3.67.0 // indirect
	github.com/buildkite/go-pipeline v0.5.0 // indirect
	...
	github.com/letsencrypt/boulder v0.0.0-20240402221617-31907e5afdad // indirect
